...
export default function FaqPage() {
  ...
  const faqs = [
    {
      q: "Comment effectuer un paiement via Mobile Money sur MarchéPlus ?",
    ...
    {
      q: "Comment ouvrir ma propre boutique étudiant ?",
    ...
    {
      q: "Est-il possible de se faire livrer directement sur le campus ?",
      a: "Oui ! MarchéPlus privilégie la proximité entre étudiants. Vous pouvez fixer un point de rendez-vous avec le vendeur (ex: Amphi 300, Resto U, Entrée principale) ou convenir d'une livraison à domicile à Yaoundé, Douala, Dschang, etc."
    },
    {
      q: "Comment fonctionne le code PIN de livraison ?",
      a: "Lors d'une commande initiée sur la plateforme, un code PIN unique à 6 chiffres est généré. Donnez ce code au vendeur SEULEMENT lorsque vous avez reçu et vérifié votre article pour confirmer la transaction."
    },
    {
      q: "Que faire en cas de litige ou de problème avec une commande ?",
      a: "En cas de problème, contactez directement l'équipe de support MarchéPlus via WhatsApp en appuyant sur le bouton 'Support WhatsApp' en bas de page."
    }
  ]
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-12 space-y-10">
      <div className="text-center space-y-3">
        ...
        <p className="text-muted-foreground text-sm">Tout ce que vous devez savoir pour utiliser MarchéPlus en toute simplicité.</p>
      </div>
      ...
      <div className="card-glass p-8 rounded-3xl bg-gradient-to-r from-emerald-600/10 to-primary/10 border border-emerald-500/20 text-center space-y-4">
        ...
        <p className="text-xs text-muted-foreground max-w-md mx-auto">Notre équipe d'assistance étudiant est disponible 7j/7 pour vous accompagner.</p>
        <a
          href={buildWhatsAppUrl('677000000', 'Bonjour support MarchéPlus, j\'ai une question concernant...')}
          target="_blank"
